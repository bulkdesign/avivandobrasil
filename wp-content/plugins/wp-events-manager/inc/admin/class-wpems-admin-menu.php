...
class WPEMS_Admin_Menu {
	...
	public function admin_menu() {
		...
		add_menu_page( __( 'Gerenciador de Eventos', 'wp-events-manager' ), __( 'Gerenciador de Eventos', 'wp-events-manager' ), 'administrator', 'tp-event-setting', null, 'dashicons-calendar-alt', 4 );
		if ( $menus ) {
