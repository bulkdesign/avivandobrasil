...
if ( ! function_exists( 'wpems_l18n' ) ) {
	function wpems_l18n() {
		return apply_filters( 'thimpress_event_l18n', array(
			...
			'l18n'            => array(
				'labels'  => array(
					__( 'Anos', 'wp-events-manager' ),
					__( 'Meses', 'wp-events-manager' ),
					__( 'Semanas', 'wp-events-manager' ),
					__( 'Dias', 'wp-events-manager' ),
					__( 'Horas', 'wp-events-manager' ),
					__( 'Minutos', 'wp-events-manager' ),
					__( 'Segundos', 'wp-events-manager' ),
				),
				'labels1' => array(
					__( 'Ano', 'wp-events-manager' ),
					__( 'Mese', 'wp-events-manager' ),
					__( 'Semana', 'wp-events-manager' ),
					__( 'Dia', 'wp-events-manager' ),
					__( 'Hora', 'wp-events-manager' ),
					__( 'Minuto', 'wp-events-manager' ),
					__( 'Segundo', 'wp-events-manager' ),
				)
			),
