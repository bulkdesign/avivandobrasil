...
<!-- TOPO -->
<div class="igrejas" style="background: url('<?php bloginfo('template_url'); ?>/images/treinamentos.jpg');background-size:cover;background-position:0 -250px;background-repeat: no-repeat;">
...
<div class="row">
  ...
  <div class="col s12 m10 push-m1 marginb50">
    <?php $igrejas = new WP_Query( array( 'post_type' => 'tp_event', 'tp_event_category' => 'treinamento' )); ?>
